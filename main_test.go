...
func TestMainHandlerCorrectRequest(t *testing.T) {
    ...
    assert.Equal(t, http.StatusOK, responseRecorder.Code, "Статус код не 200")
...
func TestMainHandlerWhenCountMoreThanTotal(t *testing.T) {
    ...
    responseBody := responseRecorder.Body.String()
    require.NotEmpty(t, responseBody, "Тело ответа пустое")
...
func TestMainHandlerWrongCityValue(t *testing.T) {
    ...
    assert.Equal(t, http.StatusBadRequest, responseRecorder.Code, "не 400 ошибка")
